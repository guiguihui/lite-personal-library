...
from app.http.routes_filesearch import router as filesearch_router
...
def create_app(cfg: AppConfig) -> FastAPI:
    ...
    # 调试追踪端点
    import logging
    _trace_log = logging.getLogger("lqd.trace")

    @app.get("/api/_trace", include_in_schema=False)
    async def _trace(msg: str = ""):
        _trace_log.warning("[TRACE] %s", msg)
        return {"ok": True}
